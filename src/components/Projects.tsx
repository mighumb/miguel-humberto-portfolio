        ...
        <div className="relative order-1 md:order-2">
          ...
          <div className="work-scroll-stage relative">
            <div
              ref={scrollRef}
              dir="ltr"
              className="work-scroll flex items-end gap-4 overflow-x-auto overflow-y-visible overscroll-x-contain scroll-pl-6 pb-4 pl-6 pt-0 md:gap-5 md:scroll-pl-10 md:pb-24 md:pl-10"
            >
