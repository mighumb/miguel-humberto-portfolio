...
function ResourceLink({ href, children }: { href: string; children: ReactNode }) {
  return (
    <a
      href={href}
      className="inline-flex cursor-pointer items-center gap-2 text-sm font-medium text-text-primary transition-colors hover:text-accent"
    >
      {children}
...
export default function ProjectDetailModal({
  ...
  return createPortal(
    <div
      className="project-modal fixed inset-0 z-[250]"
      role="dialog"
      aria-modal="true"
      aria-label={project.title[locale]}
    >
      <div className="project-modal-backdrop fixed inset-0 is-visible" aria-hidden />

      <div
        ref={modalRef}
        className="project-modal-scroll relative z-[1] h-full overflow-y-auto overscroll-contain"
      >
        <div className="project-modal-body is-visible">
          <div
          ...
          <div className="mx-auto max-w-5xl px-6 pb-24 md:px-10">
            <div className="pt-8 md:pt-12">
              <div className="project-modal-hero project-placeholder-gradient aspect-video w-full overflow-hidden rounded-xl">
              ...
              <div className="mt-8">
                <div className="flex items-baseline justify-between gap-4">
                  ...
                  <span className="shrink-0 text-xs text-text-secondary md:text-sm">{project.year}</span>
                </div>
