...
const ProjectCard = forwardRef<HTMLElement, ProjectCardProps>(function ProjectCard(
  ...
  return (
    <article
      ...
      className="work-card-focus group w-[78vw] max-w-[64rem] shrink-0 cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-accent md:w-[75vw] lg:w-[72vw]"
